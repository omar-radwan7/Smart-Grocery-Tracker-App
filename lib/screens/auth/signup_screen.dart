            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Start tracking your groceries',
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                      hintText: 'Your name',
                      prefixIcon: Icon(Icons.person_outline, size: 20, color: AppTheme.textHint),
                    ),
                        ...
                        text: const TextSpan(
                          ...
                          children: [
                            TextSpan(text: 'Sign In',
                                style: TextStyle(color: AppTheme.heroStart, fontWeight: FontWeight.w700)),
                          ],
                        ),
                      ),
                    ),
